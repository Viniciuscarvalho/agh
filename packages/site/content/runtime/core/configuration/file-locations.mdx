...
not come from a filesystem path, so they are documented in [Skills Overview](/runtime/core/skills/overview)
...
- [config.toml Reference](/runtime/core/configuration/config-toml) documents the schema for global and workspace config files.
- [mcp.json Reference](/runtime/core/configuration/mcp-json) documents JSON sidecars.
