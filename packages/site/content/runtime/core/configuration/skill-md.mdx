...
frontmatter server object. See [mcp.json Reference](/runtime/core/configuration/mcp-json) for the shared
JSON schema.
...
not discovered from scan roots. Use [Skills Overview](/runtime/core/skills/overview) for the full
...
- [config.toml Reference](/runtime/core/configuration/config-toml) documents skill marketplace trust gates.
- [mcp.json Reference](/runtime/core/configuration/mcp-json) documents sidecar validation and replacement.
- [Skills Overview](/runtime/core/skills/overview) explains catalog source precedence.
