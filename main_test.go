...
func TestRunPrintsVersion(t *testing.T) {
	t.Run("Should print the root CLI version", func(t *testing.T) {
...
func TestRunHelpShowsRootUsage(t *testing.T) {
	t.Run("Should show root usage", func(t *testing.T) {
		t.Parallel()
...
func TestRunUnknownCommandReturnsError(t *testing.T) {
	t.Run("Should return an error for unknown commands", func(t *testing.T) {
		t.Parallel()
