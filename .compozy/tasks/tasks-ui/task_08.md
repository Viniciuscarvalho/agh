...
## Subtasks
- [ ] 8.1 Extend `api/core` interfaces for task-live and aggregate task reads
- [ ] 8.2 Add shared handlers for the new task point reads, aggregate reads, and mutations
- [ ] 8.3 Extend parsers and conversions for the new task queries and payloads
- [ ] 8.4 Wire task-native streaming through the shared SSE helper path
- [ ] 8.5 Add handler, parser, and conversion coverage for the expanded surface
