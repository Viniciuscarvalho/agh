...
Lines 419, 437, and 448 only prove that _some_ validation failed. These cases will still pass if `Validate()` starts returning an unrelated error, which weakens the regression signal for the exact invariant under test.
