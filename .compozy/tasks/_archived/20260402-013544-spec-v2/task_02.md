...
Rewrite the configuration system to support the AGH-specific config.toml schema with all sections (limits, dashboard, runtime, meta, drivers), role loading from roles/_.toml files, playbook loading from playbooks/_.md files, and comprehensive validation.
