...
- Expand the env rename across all `internal/` CLI/runtime surfaces because task*02 success criteria require zero remaining internal `COLLAB*\_`/`AGI\_\_` references.
