...
func TestQueryEventsFilterBySessionID(t *testing.T) {
	...
	h.observer.OnSessionCreated(testContext(t), sessA)
	h.observer.OnSessionCreated(testContext(t), sessB)
...
func newHarness(t *testing.T) *harness {
	...
	registry, err := store.OpenGlobalDB(testContext(t), home.DatabaseFile)
	if err != nil {
