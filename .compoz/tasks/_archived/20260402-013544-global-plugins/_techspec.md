...
- [ADR-003: AGH\_\* Environment Variable Prefix Standardization](adrs/adr-003.md) — Migrate all environment variables from dual `COLLAB_*`/`AGI_*` prefixes to unified `AGH_*`.
