...
| 02  | [AGH\_\* env vars and remove BuildHookConfig from interface](task_02.md) | completed | medium     | none             |
...
- [ADR-003: AGH\_\* Environment Variable Prefix Standardization](adrs/adr-003.md)
