...
See TechSpec "SQLite schema", "Session schema change", and "store/global*db_test.go" patterns. Reuse ID generation consistent with `sess*`/`turn*` style (`ws*` prefix per ADR-002).
